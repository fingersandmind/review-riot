...
<div class="container-fluid mb-5 listing-page">
    <div class="container listing-bg clearfix text-white ctm-rounded">
        <div class="row">
            <div class="col-xl-6">
                <h6 class="category-link mb-3 mb-lg-5"><a href="{{ route('homepage') }}" class="text-white">Home</a> <i class="fas ml-3 mr-3 fa-chevron-right"></i><a href="#" class="text-white"> {{ $list->category->name }} </a><i class="fas ml-3 mr-3 fa-chevron-right"></i> <b>{{ $list->name }}</b></h6>
