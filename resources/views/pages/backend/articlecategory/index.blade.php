...
<div class="page-title">
    <div class="row gutters">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            <h5 class="title">Article Categories</h5>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="daterange-container pr-5">
                <a class="btn btn-secondary btn-rounded" href="{{ route('articlecategory.create') }}"><span class="icon-add"></span> New Category</a>
            </div>
        </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('articlecategory.show', $category->slug) }}">View</a>
                                                <a class="dropdown-item" href="{{ route('articlecategory.edit',$category->slug) }}">Edit</a>
                                                <form action="{{ route('articlecategory.destroy',$category->slug) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
