...
<div class="page-title">
    <div class="row gutters">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            <h5 class="title">Articles Create</h5>
        </div>
                ...
                <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <div class="form-group">
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title Here" value="{{ old('title') }}">
                            @error('title')
                    ...
                    <div class="card-body">
                        ...
                        <textarea name="body" class="texteditor @error('body') is-invalid @enderror" placeholder="Content here">{{ old('body') }}</textarea>
                        @error('body')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch pt-4 pb-4">
                                    <input type="checkbox" class="custom-control-input" value="1" name="is_featured" id="customSwitch3" >
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="text" class="form-control @error('logo_title') is-invalid @enderror" name="logo_title" placeholder="Title here.." value="{{ old('logo_title') }}" required>
                                    @error('logo_title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                @enderror
                                <div class="custom-control custom-switch pt-4 pb-4">
                                    <input type="checkbox" class="custom-control-input" value="1" name="is_toggled" id="customSwitch2" >
                    ...
                    <div class="card-body">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="company_name" name="company_name" class="form-control @error('company_name') is-invalid @enderror" placeholder="Review Riot Co." value="{{ old('company_name') }}">
                                @error('company_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" id="url" name="url" class="form-control @error('url') is-invalid @enderror" placeholder="https://example.com" pattern="https://.*" value="{{ old('url') }}">
                                <small id="phone" class="text-muted">
                                    Must be a valid url.
                                </small>
                                @error('url')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="phone" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="1234-456-7890" value="{{ old('phone') }}">
                                <small id="phone" class="text-muted">
