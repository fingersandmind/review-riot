                ...
                <form action="{{ route('pages.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-header">
                        <div class="form-group">
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title Here" value="{{ old('title') }}" required>
                            @error('title')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="custom-control custom-switch pt-4 pb-4 flex">
                                    <input type="number" class="form-control @error('order_no') is-invalid @enderror" name="order_no" id="orderNumber" placeholder="Order No." value="{{ old('order_no') }}">
                                    @error('order_no')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <div class="card-body">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="meta_desc" class="form-control @error('meta_desc') is-invalid @enderror" id="" cols="30" rows="5"></textarea>
                                </small>
                                @error('meta_desc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="og_title" name="og_title" class="form-control @error('og_title') is-invalid @enderror" value="{{ old('og_title') }}">
                                @error('og_title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="og_desc" class="form-control @error('og_desc') is-invalid @enderror" id="" cols="30" rows="5">{{ old('og_desc') }}</textarea>
                                </small>
                                @error('og_desc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="og_url" name="og_url" class="form-control @error('og_url') is-invalid @enderror" value="{{ old('og_url') }}">
                                @error('og_url')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group pt-5">
                                ...
                                <input type="text" id="twitter_title" name="twitter_title" class="form-control @error('twitter_title') is-invalid @enderror" value="{{ old('twitter_title') }}">
                                @error('twitter_title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="twitter_desc" class="form-control @error('twitter_desc') is-invalid @enderror" id="" cols="30" rows="5">{{ old('twitter_desc') }}</textarea>
                                </small>
                                @error('twitter_desc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
