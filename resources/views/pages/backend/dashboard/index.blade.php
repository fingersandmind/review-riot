                        ...
                        <div class="overall-rating">
                            <div class="rating-header">
                                ...
                                <div class="rating-box">
                                    <img src="{{ asset('assets/backend/img/star-selected.svg') }}" class="star" alt="Rating" />
                                    <img src="{{ asset('assets/backend/img/star-selected.svg') }}" class="star" alt="Rating" />
                                    <img src="{{ asset('assets/backend/img/star-selected.svg') }}" class="star" alt="Rating" />
                                    <img src="{{ asset('assets/backend/img/star-selected.svg') }}" class="star" alt="Rating" />
                                    <img src="{{ asset('assets/backend/img/star-selected.svg') }}" class="star" alt="Rating" />
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="notify info">
                    <div class="notify-body">
                        ...
                        <div class="notify-title">Give your valuable feedback.<img src="{{ asset('assets/backend/img/notification-info.svg') }}" alt="" /></div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="notify danger">
                    <div class="notify-body">
                        ...
                        <div class="notify-title">Give your valuable feedback.<img src="{{ asset('assets/backend/img/notification-danger.svg') }}" alt="" /></div>
                        <div class="notify-text">How likely are you to recommend Retail Dashboard to your friends?</div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                <div class="notify success">
                    <div class="notify-body">
                        ...
                        <div class="notify-title">Give your valuable feedback.<img src="{{ asset('assets/backend/img/notification-success.svg') }}" alt="" /></div>
                        <div class="notify-text">How likely are you to recommend Retail Dashboard to your friends?</div>
                    </div>
                </div>
            </div>
